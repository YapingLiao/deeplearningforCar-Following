...
if __name__ == '__main__':
    ...
    min4=0
    max4=28.1513                         
    data=sio.loadmat('trainset10.mat') 
    trainset=data['trainset']
    data1=sio.loadmat('aimset10.mat')
    aimset=data1['aimset']
    ...
    mkdir('result')
    model.save_weights('result\vprediction10to1.h5')
    data2=sio.loadmat('valid10.mat')
    validset=data2['valid']    
    prediction=model.predict(validset)
    
    numpy.savetxt('result\200000samplevprediction10to1.txt',prediction)