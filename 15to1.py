# -*- coding: utf-8 -*-
"""
Created on Fri Aug 19 09:39:26 2016
...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 19 09:34:45 2016
...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug 08 04:57:46 2016
...
def build_model():
   ...
   # model.add(Dropout(0.8))
    model.add(GRU(300,init='lecun_uniform', input_shape=(15,3), return_sequences=True,activation ='sigmoid'))
...
if __name__ == '__main__':
    ...
    min4=0
    max4=28.1513                         
    data=sio.loadmat('trainset15.mat') 
    trainset=data['trainset']
    data1=sio.loadmat('aimset15.mat')
    aimset=data1['aimset']
    ...
    model.save_weights('result\vprediction15to1.h5')
    data2=sio.loadmat('valid15.mat')
    validset=data2['valid']    
    prediction=model.predict(validset)
    
    numpy.savetxt('result\200000samplevprediction15to1.txt',prediction)