...
def build_model():
   ...
   # model.add(Dropout(0.8))
    model.add(GRU(300,init='lecun_uniform', input_shape=(1,3), return_sequences=True,activation ='sigmoid'))
...
if __name__ == '__main__':
    ...
    min4=0
    max4=28.1513                         
    data=sio.loadmat('trainset1.mat') 
    trainset=data['trainset']
    data1=sio.loadmat('aimset1.mat')
    aimset=data1['aimset']
    ...
    mkdir('result')
    model.save_weights('result\vprediction1to1.h5')
    data2=sio.loadmat('valid1.mat')
    validset=data2['valid']    
    prediction=model.predict(validset)
    
    numpy.savetxt('result\200000samplevprediction1to1.txt',prediction)